  ...
  projects: [
    {
      ...
      image: "https://via.placeholder.com/400x250/0066cc/ffffff?text=E-Commerce+Platform",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/009900/ffffff?text=Task+Manager",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/cc6600/ffffff?text=Data+Dashboard",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/9900cc/ffffff?text=AI+Chatbot",
  ...
  blogPosts: [
    {
      ...
      category: "Technical",
      date: "2024-01-15",
      excerpt: "A comprehensive guide to modern web development practices and tools in 2024.",
      readTime: 8,
    ...
    },
    {
      ...
      category: "Personal",
      date: "2024-01-20",
      excerpt: "Reflecting on my coding journey and the lessons learned along the way.",
      readTime: 5,
    ...
    },
    {
      ...
      date: "2024-01-25",
      excerpt: "Exploring how remote work is changing the professional landscape and what it means for the future.",
      readTime: 6,
    ...
    },
    {
      ...
      category: "Technical",
      date: "2024-02-01",
      excerpt: "Practical tips and techniques for improving React application performance.",
      readTime: 10,
...
// DOM Elements
let fileItems, pages, tabBar, breadcrumb, statusBar, themeToggle, loadingSpinner;
...
function setActiveNavigation(pageId) {
  ...
  const activeItem = document.querySelector(`[data-page="${pageId}"].file-item`);
  if (activeItem) {
...
function startTypingAnimation() {
  const text = "Hello, I'm John Developer";
...
function filterBlogPosts(filter) {
  if (filter === 'all') {
    ...
    filteredPosts = appData.blogPosts.filter(post => post.category === filter);
  }
...
function searchBlogPosts(searchTerm) {
  let postsToSearch = currentFilter === 'all' ? appData.blogPosts : 
...
function showFormMessage(message, type = 'info') {
  ...
  messageDiv.style.cssText = `
    ...
    font-size: 14px;
    font-weight: 500;
    ${type === 'success' ? 'background: var(--vscode-success); color: white;' : ''}
    ${type === 'error' ? 'background: var(--vscode-error); color: white;' : ''}
    ${type === 'info' ? 'background: var(--vscode-bg-secondary); color: var(--vscode-text-primary); border: 1px solid var(--vscode-border);' : ''}
  `;
...
function updateHistory(page) {
  const title = `John Developer - ${page.charAt(0).toUpperCase() + page.slice(1)}`;
  const url = `#${page}`;
